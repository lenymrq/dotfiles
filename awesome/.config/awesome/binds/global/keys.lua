...
awful.keyboard.append_global_keybindings({
   ...
   -- Custom
   awful.key({ modkey,           }, 'x', lock,
      { description = 'lock the screen', group = 'screen'}),
   awful.key({ modkey,           }, 'd', function() awful.spawn('rofi -show run') end,
      { description = 'show program launcher' , group = 'launcher'}),
   
   -- Audio
   awful.key({                   }, 'XF86AudioRaiseVolume', function() awesome.emit_signal('audio::up', 5) end),
   awful.key({                   }, 'XF86AudioLowerVolume', function() awesome.emit_signal('audio::down', 5) end),
   awful.key({                   }, 'XF86AudioMute', function() awesome.emit_signal('audio::mute') end),
   awful.key({                   }, 'XF86AudioMicMute', function() awful.spawn.easy_async('amixer set Capture toggle') end),

   -- Brightness
   awful.key({                   }, 'XF86MonBrightnessUp', function() awesome.emit_signal('brightness::up', 5) end),
   awful.key({                   }, 'XF86MonBrightnessDown', function() awesome.emit_signal('brightness::down', 5) end),
