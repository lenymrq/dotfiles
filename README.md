...
1. [Install awesome git](https://www.reddit.com/r/awesomewm/comments/xi6ab5/installing_awesomewm).
...
The only package that requires a specific version is `awesome`—you need the upstream version from GitHub, as the stable release will not work.
